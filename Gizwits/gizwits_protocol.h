...
* @{
*/
#define PRODUCT_KEY "7820fc136f3646b9855e4e08c8c1752c"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "d09b98b0df414e41a5d1a5761cbbeca7"
...
#define Buzzer_LEN                           1
#define Remind_drink_switch_BYTEOFFSET                    0
#define Remind_drink_switch_BITOFFSET                     1
#define Remind_drink_switch_LEN                           1

#define Total_amount_of_water_RATIO                         1
#define Total_amount_of_water_ADDITION                      0
#define Total_amount_of_water_MIN                           0
#define Total_amount_of_water_MAX                           4000
#define Recommended_amount_of_water_RATIO                         1
#define Recommended_amount_of_water_ADDITION                      0
#define Recommended_amount_of_water_MIN                           0
#define Recommended_amount_of_water_MAX                           2000
...
#define RSSI_1_RATIO                         1
#define RSSI_1_ADDITION                      0
#define RSSI_1_MIN                           0
#define RSSI_1_MAX                           255
#define RSSI_2_RATIO                         1
#define RSSI_2_ADDITION                      0
#define RSSI_2_MIN                           0
#define RSSI_2_MAX                           255
#define RSSI_3_RATIO                         1
#define RSSI_3_ADDITION                      0
#define RSSI_3_MIN                           0
#define RSSI_3_MAX                           255
#define Month_RATIO                         1
#define Month_ADDITION                      0
#define Month_MIN                           0
#define Month_MAX                           12
#define Day_RATIO                         1
#define Day_ADDITION                      0
#define Day_MIN                           0
#define Day_MAX                           31
#define Hour_RATIO                         1
#define Hour_ADDITION                      0
#define Hour_MIN                           0
#define Hour_MAX                           24
#define Minute_RATIO                         1
#define Minute_ADDITION                      0
#define Minute_MIN                           0
...
#define LAC_1_RATIO                         1
#define LAC_1_ADDITION                      0
#define LAC_1_MIN                           0
#define LAC_1_MAX                           65535
#define CellID_1_RATIO                         1
#define CellID_1_ADDITION                      0
#define CellID_1_MIN                           0
#define CellID_1_MAX                           65535
#define LAC_2_RATIO                         1
#define LAC_2_ADDITION                      0
#define LAC_2_MIN                           0
#define LAC_2_MAX                           65535
#define CellID_2_RATIO                         1
#define CellID_2_ADDITION                      0
#define CellID_2_MIN                           0
#define CellID_2_MAX                           65535
#define LAC_3_RATIO                         1
#define LAC_3_ADDITION                      0
#define LAC_3_MIN                           0
#define LAC_3_MAX                           65535
#define CellID_3_RATIO                         1
#define CellID_3_ADDITION                      0
#define CellID_3_MIN                           0
#define CellID_3_MAX                           65535
#define Year_RATIO                         1
#define Year_ADDITION                      0
#define Year_MIN                           0
#define Year_MAX                           2300
/**@} */
...
typedef enum
{
  ...
  EVENT_Buzzer,
  EVENT_Remind_drink_switch,
  EVENT_Total_amount_of_water,
  EVENT_Recommended_amount_of_water,
...
typedef struct {
  bool valueBuzzer;
  bool valueRemind_drink_switch;
  uint32_t valueTotal_amount_of_water;
  uint32_t valueRecommended_amount_of_water;
  int32_t valueTemperature;
  uint32_t valuehumidity;
  uint32_t valueRSSI_1;
  uint32_t valueRSSI_2;
  uint32_t valueRSSI_3;
  uint32_t valueMonth;
  uint32_t valueDay;
  uint32_t valueHour;
  uint32_t valueMinute;
  uint32_t valueWater;
  uint32_t valueLAC_1;
  uint32_t valueCellID_1;
  uint32_t valueLAC_2;
  uint32_t valueCellID_2;
  uint32_t valueLAC_3;
  uint32_t valueCellID_3;
  uint32_t valueYear;
} dataPoint_t;
...
typedef struct {
  ...
  uint8_t flagRemind_drink_switch:1;
  uint8_t flagTotal_amount_of_water:1;
  uint8_t flagRecommended_amount_of_water:1;
} attrFlags_t;
...
typedef struct {
  ...
  uint16_t valueTotal_amount_of_water;
  uint16_t valueRecommended_amount_of_water;
} attrVals_t;
...
typedef struct {
  ...
  uint16_t valueWater;
  uint16_t valueLAC_1;
  uint16_t valueCellID_1;
  uint16_t valueLAC_2;
  uint16_t valueCellID_2;
  uint16_t valueLAC_3;
  uint16_t valueCellID_3;
  uint16_t valueYear;
} devStatus_t; 
